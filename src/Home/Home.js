...
I have a strong background in full-stack development and have held leadership roles as a team lead and software architect for over{' '}<Years className="developer-years" digits="0"startDate="Oct 1, 2015" />{' '}years.</p>
...
<p>My passion is software development using the <b>.NET</b> stack and <b>JavaScript</b>, including front-end frameworks such as <b>Angular</b> and <b>React</b>. I am highly skilled in modern programming languages, applications, infrastructure, and tools such as Kubernetes, Docker, SQL, Redis, Elasticsearch, and queuing systems.</p>
